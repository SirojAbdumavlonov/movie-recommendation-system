 ...
 */
@Repository
public interface UsersRepository extends UsersRepositoryWithBagRelationships, JpaRepository<Users, Integer> {
    default Optional<Users> findOneWithEagerRelationships(Integer id) {
